...
#quantum-circuit(
  row-spacing: 6pt,
  lstick($|0〉$), 10pt, group(3, 2, label: (content: "Prepare")), gate($H$), ctrl(2), 3pt, 
    group(4, 2, label: (content: "Verify")), 3, group(7, 3, label: (content: [Controlled-$M$])), 
    ctrl(4), 2, 10pt, group(3, 2, label: (content: "Decode")), ctrl(2), gate($H$), meter(), [\ ],  
